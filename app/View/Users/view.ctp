<div class="container-fluid uView ">
	...
	<div class="row row-centered">
		<div class="about col-xs-8 col-centered">
			<h3>About:</h3>
			<h4>iGem Track: <p><?php echo $this->Html->link($user['Category']['name'], array('controller' => 'categories', 'action' => 'view', $user['Category']['id'])); ?> <p></h4>
			<h4>Keywords:<p> <?php foreach($user['Keyword'] as $keyword)
			{
